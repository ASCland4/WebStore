        ...
        <div class="col">
            ...
            <div style="margin-bottom: 80px;">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end align-middle"><?= number_format($produto['preco'], 2, ',', '.') . '$' ?>
                            </td>
                        </tr>
                ...
                <div class="form-check">
                    <input class="form-check-input" onchange="usar_morada_alternativa()" type="checkbox"
                        name="check_morada_alternativa" id="check_morada_alternativa">
                    <label class="form-check-label" for="check_morada_alternativa">Definir uma morada
                        alternativa.</label>
                </div>
                ...
                <div class="row my-5">
                    ...
                    <div class="col text-end">
                        <a href="?a=confirmar_encomenda" onclick="morada_alternativa()"
                            class="btn btn-primary">Confirmar encomenda</a>
                    </div>
                </div>
            </div>
        </div>
