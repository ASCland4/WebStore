        ...
        <div class="col-sm-6 offset-sm-3">
            ...
            <form action="?a=criar_cliente" method="post">
                ...
                <div class="my-3">
                    ...
                    <input type="password" name="text_senha_2" placeholder="Repetir a senha" class="form-control"
                        required>
                </div>
                ...
                <div class="my-3">
                    ...
                    <input type="text" name="text_nome_completo" placeholder="Nome Completo" class="form-control"
                        required>
                </div>
